...
```{r recherche_indics, eval=T , echo=F, message=F, warning=F}
indicateurs_SGF %>% slice(1:5) %>%
  kableExtra::kable() %>%
  kableExtra::kable_styling(font_size = 9.5, bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
