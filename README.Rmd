...
Les contours des départements de France métropolitaine ont évolués sur la période que couvre les données de la SGF.
Les 5 millésimes de cette géographie départementale sont disponibles dans la table `geo_DEP_SGF_histo` :

```{r example , eval=T, echo=F, message=F, warning=F , dpi= 500}
