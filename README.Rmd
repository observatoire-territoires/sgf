...
La recherche des indicateurs se fait directement dans la table __indicateurs_SGF__ : une fois la source et le numéro des variables sélectionnés, la fonction __sgf_sfdf__ permet de générer un sf dataframe des départements avec les indicateurs correspondants, au format large :


```{r plot_exemple_data , eval=T , warning=F}
library(sgf)
